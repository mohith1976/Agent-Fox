...
export class ExpenseWorkflow {
  ...
  private buildGraph(workflowPrompt: string, allowedToolCodes: string[]) {
    ...
    const compiledGraph = new StateGraph(ExpenseWorkflowState)
      ...
      .addNode('read_terminology_lists', nodes.read_terminology_lists)
      .addNode('generate_terminology_answer', nodes.generate_terminology_answer)
      ...
      .addConditionalEdges('interpret_query', ExpenseEdges.routeAfterInterpret)
      .addEdge('read_terminology_lists', 'generate_terminology_answer')
      .addEdge('generate_terminology_answer', END)
